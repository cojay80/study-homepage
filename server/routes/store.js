...
const STORE_CATALOG = [
  ...
  { id: 'wall_deepsea', name: '심해 벽지', type: 'wallpaper', price: 500, icon: '🌊', color: '#01579B' },
  { id: 'wall_medieval', name: '중세 성 벽지', type: 'wallpaper', price: 500, icon: '🏰', color: '#BCAAA4' },
  { id: 'wall_carnival', name: '카니발 벽지', type: 'wallpaper', price: 500, icon: '🎪', color: '#F8BBD0' },
  { id: 'wall_cave', name: '동굴 벽지', type: 'wallpaper', price: 400, icon: '🕳️', color: '#8D6E63' },
  ...
  { id: 'submarine_furniture', name: '잠수함', type: 'furniture', price: 500, icon: '🚤' },
  { id: 'watchtower', name: '망루', type: 'furniture', price: 400, icon: '🏰' },
  { id: 'bumper_car', name: '범퍼카', type: 'furniture', price: 400, icon: '🚗' },
  { id: 'cotton_candy_stand', name: '솜사탕 가판대', type: 'furniture', price: 300, icon: '🍭' },
  { id: 'ticket_booth', name: '매표소', type: 'furniture', price: 300, icon: '🎫' },
  { id: 'mineral_display_case', name: '광물 진열장', type: 'furniture', price: 350, icon: '💎' },
  { id: 'drawbridge', name: '도개교', type: 'furniture', price: 400, icon: '🌉' },
  { id: 'lifeguard_tower', name: '안전요원 감시탑', type: 'furniture', price: 350, icon: '🏖️' },
  ...
  { id: 'periscope_deco', name: '잠망경', type: 'decor', price: 150, icon: '🔭' },
  { id: 'deep_sea_light', name: '심해 조명', type: 'decor', price: 180, icon: '💡' },
  { id: 'angler_fish_deco', name: '아귀 물고기 인형', type: 'decor', price: 150, icon: '🐟' },
  { id: 'sea_cave_deco', name: '바다 동굴 장식', type: 'decor', price: 200, icon: '🕳️' },
  { id: 'sonar_deco', name: '음파 탐지기', type: 'decor', price: 180, icon: '📡' },
  { id: 'oxygen_tank_deco', name: '산소통', type: 'decor', price: 150, icon: '🫧' },
  { id: 'catapult_deco', name: '투석기', type: 'decor', price: 200, icon: '🏹' },
  { id: 'castle_wall_deco', name: '성벽 장식', type: 'decor', price: 200, icon: '🧱' },
  { id: 'banner_medieval_deco', name: '중세 깃발', type: 'decor', price: 130, icon: '🚩' },
  { id: 'moat_deco', name: '해자 장식', type: 'decor', price: 180, icon: '🌊' },
  { id: 'knight_horse_deco', name: '기사의 말 인형', type: 'decor', price: 220, icon: '🐴' },
  { id: 'jousting_lance', name: '마상 창', type: 'decor', price: 150, icon: '🔱' },
  { id: 'roller_coaster_deco', name: '롤러코스터 모형', type: 'decor', price: 250, icon: '🎢' },
  { id: 'ring_toss_game', name: '고리 던지기 게임', type: 'decor', price: 130, icon: '⭕' },
  { id: 'prize_wall_deco', name: '경품 진열대', type: 'decor', price: 180, icon: '🧸' },
  { id: 'carnival_lights', name: '축제 조명', type: 'decor', price: 150, icon: '🎇' },
  { id: 'funnel_cake_deco', name: '퍼널 케이크', type: 'decor', price: 90, icon: '🥞' },
  { id: 'balloon_dart_deco', name: '풍선 다트 게임', type: 'decor', price: 130, icon: '🎯' },
  { id: 'gem_collection_deco', name: '보석 컬렉션', type: 'decor', price: 200, icon: '💎' },
  { id: 'crystal_deco', name: '수정', type: 'decor', price: 150, icon: '🔮' },
  { id: 'geode_deco', name: '정동석', type: 'decor', price: 180, icon: '🪨' },
  { id: 'rock_polisher', name: '돌 연마기', type: 'decor', price: 200, icon: '⚙️' },
  { id: 'fossil_rock_deco', name: '화석 암석', type: 'decor', price: 150, icon: '🪨' },
  { id: 'bubble_wand_deco', name: '비눗방울 막대', type: 'decor', price: 60, icon: '🫧' },
  { id: 'sidewalk_chalk', name: '분필', type: 'decor', price: 50, icon: '🖍️' },
  { id: 'hopscotch_deco', name: '사방치기 판', type: 'decor', price: 80, icon: '🔢' },
  { id: 'pinwheel_deco', name: '바람개비', type: 'decor', price: 70, icon: '🎐' },
  { id: 'sandbox_deco', name: '모래놀이통', type: 'decor', price: 150, icon: '🏖️' },
  { id: 'water_gun_deco', name: '물총', type: 'decor', price: 90, icon: '🔫' },
  { id: 'frisbee_deco', name: '원반', type: 'decor', price: 70, icon: '🥏' },
  { id: 'board_game_box', name: '보드게임 상자', type: 'decor', price: 150, icon: '📦' },
  { id: 'playing_cards_deco', name: '카드놀이', type: 'decor', price: 80, icon: '🃏' },
  { id: 'magic_trick_deco', name: '마술 도구', type: 'decor', price: 150, icon: '🎩' },
  { id: 'kaleidoscope_deco', name: '만화경', type: 'decor', price: 100, icon: '🔮' },
  { id: 'slinky_deco', name: '스프링 장난감', type: 'decor', price: 60, icon: '🌀' },
  ...
  { id: 'diving_suit', name: '잠수복', type: 'clothing', price: 300, icon: '🤿' },
  { id: 'knight_armor_costume', name: '기사 갑옷 의상', type: 'clothing', price: 350, icon: '🛡️' },
  { id: 'carnival_mask', name: '축제 가면', type: 'clothing', price: 180, icon: '🎭' },
  { id: 'treasure_hunter_vest', name: '보물사냥꾼 조끼', type: 'clothing', price: 220, icon: '🦺' },
  { id: 'geologist_vest', name: '지질학자 조끼', type: 'clothing', price: 200, icon: '🦺' },
  { id: 'pirate_eye_patch', name: '해적 안대', type: 'clothing', price: 80, icon: '🏴' },
  ...
  { id: 'pet_octopus', name: '문어', type: 'pet', price: 500, icon: '🐙' },
  { id: 'pet_crab', name: '게', type: 'pet', price: 350, icon: '🦀' },
  { id: 'pet_stingray', name: '가오리', type: 'pet', price: 500, icon: '🐡' },
  { id: 'pet_orca', name: '범고래', type: 'pet', price: 700, icon: '🐋' },
  { id: 'pet_seagull', name: '갈매기', type: 'pet', price: 350, icon: '🐦' },
];
